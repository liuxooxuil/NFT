...
contract Shared1155TokenSSSS is AccessControl, Pausable, ERC1155, ERC1155Burnable, ERC1155URIStorage, ERC1155Supply {
    ...
    function transferERC20(
        ...
        require(to != address(0), "Shared1155Token: Transfer to zero address");
        require(amount > 0, "Shared1155Token: Transfer amount must be greater than zero");

        IERC20 token = IERC20(erc20Token);
        require(token.transferFrom(_msgSender(), to, amount), "Shared1155Token: ERC20 transfer failed");

        emit ERC20Transferred(erc20Token, to, amount);
    }
}